<template>
  ...
  >
    ...
    <h1 style="color:#2d8cf0">注册管理员</h1>
    <br>
    <FormItem label="账号名" prop="user_name">
      <Input type="text" v-model="formValidate.user_name" placeholder="包括中文字、英文字母、数字和下划线"></Input>
    </FormItem>

    <FormItem label="密码" prop="password">
      <Input type="password" v-model="formValidate.password" placeholder="数字,小写字母,大写字母,特殊符号至少包含三种,长度为 8 - 30位"></Input>
    </FormItem>
    <FormItem label="确认密码" prop="passwdCheck">
      <Input type="password" v-model="formValidate.passwdCheck"></Input>
    </FormItem>
    <FormItem label="姓名" prop="first_name">
      <Input type="text" v-model="formValidate.first_name"></Input>
    </FormItem>
    <FormItem label="电子邮箱" prop="email">
      <Input v-model="formValidate.email" placeholder="我们将发送确认注册邮件至您的邮箱"></Input>
    </FormItem>
    <FormItem label="手机号">
    ...
    <FormItem label="公司名称" prop="company_name">
      <Input v-model="formValidate.company_name"></Input>
    </FormItem>
